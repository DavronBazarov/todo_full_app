              ...
              child: finalTskList.isEmpty
                ...
                builder: (context, TaskProvider tskProvider, child) {
                  ...
                  return tskProvider.loading
                    ...
                    itemBuilder: (_, index) {
                      final String taskStatus = finalTskList[index]
                          .statusTaskForUpdate
                          .toString();
                      return Dismissible(
                        key: ValueKey(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                      if (taskStatus == "clouded" ||
                                          taskStatus == "edited" ||
                                          taskStatus == "toggled")
                                        const Icon(Icons
                                            .cloud_done_outlined),
                                      if (taskStatus == "noClouded" ||
                                          taskStatus == "noEdited" ||
                                          taskStatus == "noToggle")
